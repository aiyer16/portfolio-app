        ...
        return (
            <section className="panel spotlight medium center" id="first" >
                <div className="content span-7">
                    ...
                    <p style={{ textAlign: "justify" }}> I am a <b>Data Engineer </b>who is obsessed with solving complex problems
                    and passionate about the power of analytics to help drive ideas forward. I am currently working on furthering <b>ETL</b> capabilities
